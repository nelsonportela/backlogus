      ...
      <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
        ...
        <div>
          ...
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            System preference will automatically switch between light and dark based on your device settings.
          </p>
        </div>
      </div>
      ...
      <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center">
            ...
            />
            <label for="show-spoilers" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
          ...
          <div class="flex items-center">
            <input
              ...
              class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
            />
            <label for="auto-update-status" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
        ...
        <div class="space-y-4">
          <div class="flex items-center">
            <input
              ...
              class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
            />
            <label for="email-updates" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
          ...
          <div class="flex items-center">
            <input
              ...
              class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
            />
            <label for="release-notifications" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
...
const submitForm = async () => {
  ...
  try {
    ...
    localStorage.setItem('media_tracker_preferences', JSON.stringify({
