    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        ...
        <div
          ...
          <nav
            class="-mb-px flex space-x-8 px-6 min-w-0 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100"
...
const handleImportData = async (file) => {
  try {
    ...
    if (result.success) {
      showMessage(
        "Backup imported successfully! Please refresh the page to see your restored data."
      );
